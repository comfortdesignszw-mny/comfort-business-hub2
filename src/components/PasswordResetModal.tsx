...
export default function PasswordResetModal({ isOpen, onClose, defaultEmail = '' }: PasswordResetModalProps) {
  ...
  return (
    <AnimatePresence>
      <div key="password-reset-modal-wrapper" className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
        <motion.div
          key="password-reset-modal-dialog"
