...
export default function BiometricAuthModal({
  ...
  return (
    <AnimatePresence>
      <div key="biometric-auth-modal-wrapper" className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-black/80 backdrop-blur-md">
        <motion.div
          key="biometric-auth-modal-dialog"
