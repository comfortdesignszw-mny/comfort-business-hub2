...
const TOS_ENGLISH: TOSContent = {
  ...
  welcome1: "Welcome to Comfort Business Hub (\"the Platform\"). These Terms of Service (\"Terms\") govern your access to and use of our web application, tools, and services.",
  welcome2: "By signing up for an account, creating a storefront, or purchasing goods/services through the Platform, you agree to be bound by these Terms. If you do not agree to these Terms, you may not use the Platform.",
  sec1Title: "01. Description of Service",
  ...
  sec1NoteTitle: "Guest & Anonymous Modes:",
  sec1NoteBody: "In addition to full membership, the Platform supports Guest Browsing and Guest Access modes. Anonymous explorers can browse public inventories and share nodes, while user-activated Guest Sessions allow users to register a local temporary identifier and test transactions (e.g., placing inquiries via the \"Talk\" option or submitting purchase intents via \"Order Now\" commands) to preview the system seamlessly.",
  recentUpdatesTitle: "Recent Updates (July 2026)",
  recentUpdates: [
    "Multi-Gateway Payment Configuration: Suppliers can configure, activate, and customize their preferred payment methods (including PayPal, Stripe, EcoCash USSD codes, Cash/Pay on Delivery, and PayNow). Buyers are presented with supplier-configured payment methods upon checkout.",
    "Direct WhatsApp App Uplink: Product and ad \"Talk on WhatsApp\" buttons intelligently detect whether WhatsApp Business or Regular WhatsApp is installed on the user's device and route communication seamlessly.",
    "Your Live Inventory Controls: Suppliers gain direct access to manage and review \"Your Live Inventory\" straight from their user profile terminal.",
    "Verified Operator Accounts: The platform grants Verified Operator status (indicated by a green shield) to recognized partners at the sole discretion of the Administration team.",
    "Location Services: We use location data (including default geographic approximation at login) to suggest locally relevant products and services.",
    "Classified Ads: Users are entitled to a maximum of 5 Spotlight Classified Ads per month. These ads remain active for up to 30 days and are subject to community guidelines.",
    "Image Uploads: Local image uploads for product catalogs are restricted to 2 assets to preserve bandwidth, while external URL assets support up to 5 images per product."
  ],
...
const TOS_SHONA: TOSContent = {
  ...
  recentUpdatesTitle: "Zvakavandudzwa Zvazvino (Chikunguru 2026)",
  recentUpdates: [
    ...
    "Dzora Inventory Yenyu: Vatengesi vanowana mukana wekutonga nekuongorora \"Live Inventory\" kubva paprofile yavo.",
    "Verified Operator Status: Platform inopa Verified Operator Status (nemufananidzo we-shield ye green) kune vaoneswa chokwadi neAdmin.",
    "Masevhisi eNzvimbo: Ndangariro dzenzvimbo dzinoshandiswa kuratidza zvigadzirwa zviri pedyo nemi.",
    "Zvinyorwa Zvekushambadza (Classified Ads): Vashandisi vanowana mikana 5 yekushambadza pamwedzi panguva inosvika mazuva makumi matatu.",
    "Kuisa Mifananidzo: Mifananidzo ye zvinhu inogona kuiswa kusvika pa-2 assets pa-local mudziyo kana pa-5 kubudikidza ma-URL."
  ],
...
const TOS_NDEBELE: TOSContent = {
  ...
  recentUpdatesTitle: "Okusanda Kwelulwa (July 2026)",
  recentUpdates: [
    ...
    "Lawula Izitolo Zakho: Abathengisi balamandla okulawula nohlola \"Live Inventory\" kwi-profile yabo.",
    "Isimo se-Verified Operator: I-Platform inika i-Verified Operator Status kumi-partner abahlolisiswe nguAdmin.",
    "Amasevisi eNdawo: Indawo yakho iyasiza ukukhomba impahla eseduze nawe.",
    "Izikhangiso ze-Classified Ads: Abasebenzisi balelungelo lezikhangiso ezi-5 ngenyanga okwamalanga angu-30.",
    "Ukulayisha Imifanekiso: Imifanekiso ye-local mudziyo ingaba yi-2 per item, kuthi eye-URL iye ku-5."
  ],
